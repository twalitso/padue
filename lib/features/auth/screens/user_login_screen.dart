...
class _UserLoginScreenState extends State<UserLoginScreen> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      var user = await _authService.signInWithCredentials(
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Text(
                  'Sign in to access roadside & home assistance',
            ...
            const SizedBox(height: 16),
            // Navigation to Sign Up and Provider Login
            Container(
                  ...
                  Semantics(
                    ...
                    child: OutlinedButton.icon(
                     ...
                     // icon: const Icon(Icons.build),
                      label: const Text('Service Provider Login Here'),
